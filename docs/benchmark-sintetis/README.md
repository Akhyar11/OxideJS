...
| [v1.2.1](./v1.2.1.md) | 2026-04-21 | (latest) | Entry test tunggal `test/index.ts` dengan correctness suite + benchmark suite |
...
Contoh:
- `1.2.1`: rilis mayor `1`, fitur set keempat (`3`), dengan baseline minor baru (`0`).
