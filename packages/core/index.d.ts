...
export declare function memoryBankSimilarityScoresNative(query: Float32Array, keys: Float32Array, units: number, slots: number, similarityType: string, scoresOut: Float32Array): void
export declare function memoryBankUpdateNative(keys: Float32Array, values: Float32Array, newKey: Float32Array, newValue: Float32Array, slot: number, gate: Float32Array, units: number, slots: number): void
...
export declare function adaptiveMemoryRnnForwardNativeInto(wq: Float32Array, wm: Float32Array, wxh: Float32Array, whh: Float32Array, bh: Float32Array, wg: Float32Array, bg: Float32Array, xSeq: Float32Array, h0: Float32Array, hiddenUnits: number, inputUnits: number, memoryDim: number, memorySlots: number, seqLen: number, batchSize: number, useRelu: boolean, hSeqOut: Float32Array, actGrad: Float32Array, memKeys: Float32Array, memValues: Float32Array, memUsage: Float32Array, combinedOut: Float32Array): void
export declare function adaptiveMemoryRnnBackwardNativeInto(wxh: Float32Array, whh: Float32Array, combined: Float32Array, hSeq: Float32Array, actGrad: Float32Array, errH: Float32Array, hiddenUnits: number, inputUnits: number, memoryDim: number, seqLen: number, batchSize: number, dwxh: Float32Array, dwhh: Float32Array, dbh: Float32Array, dxOut: Float32Array): void
export declare function adaptiveMemoryRnnBackwardFullNativeInto(wxh: Float32Array, whh: Float32Array, wq: Float32Array, wm: Float32Array, wg: Float32Array, hPrev: Float32Array, h: Float32Array, dAct: Float32Array, combined: Float32Array, read: Float32Array, queryInput: Float32Array, query: Float32Array, attention: Float32Array, gateInput: Float32Array, gate: Float32Array, candidate: Float32Array, memoryKeysBefore: Float32Array, memoryValuesBefore: Float32Array, writeSlots: Int32Array, errH: Float32Array, hiddenUnits: number, inputUnits: number, memoryDim: number, memorySlots: number, seqLen: number, batchSize: number, dwxh: Float32Array, dwhh: Float32Array, dbh: Float32Array, dwq: Float32Array, dwm: Float32Array, dwg: Float32Array, dbg: Float32Array, dxOut: Float32Array): void
